...
page = st.sidebar.radio(
    "Workspace",
    ["Live Terminal", "Signal Reactor", "Market Radar", "Model Health", "Easy Mode", "Upload Data"],
)
...
if page == "Live Terminal":
    ...
    st.markdown(
        '<div class="terminal-head"><div class="live-line">DATA UPLOAD</div>'
        '<div class="terminal-title">Inspect a market dataset</div>'
